        ...
        <div className="benefits-grid">
          <div className="benefit-card">
            <div className="icon-wrapper">
              <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#555">
          ...
          <div className="benefit-card">
            ...
            <div className="benefit-text">
              ...
              <p>Choose from countless themes, outfits, or backgrounds—so each portrait truly captures your child's personality.</p>
            </div>
          </div>
        </div>
      </div>
